...
def main():
    ...
    while opcion:
        ...
        if opcion=="1" or opcion=="REGISTRO":
            ...
            if regresar: 
                print("{nombre} {apellido} se registro correctamente con el e-mail {email}")
            else:
                print("por favor intentelo de nuevo ... no fue posible realizar el registro en este momento...")              
            ...
            if lista_usuario:
                ...
                print("El E-mail y/o Contraseña son inorrectos... Por favor intentelo nuevamente")
            funciones.esperarTecla()
